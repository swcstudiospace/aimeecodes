...
```bash
bash .omega/skills/write-release-notes/scripts/fetch-release-data.sh <version> [owner/repo]
```
...
- **Lead with what changed**: "You can now..." or "Omega now..." beats "We added..."
...
```bash
echo "<release notes>" | bash .omega/skills/write-release-notes/scripts/validate-release-notes.sh
```
