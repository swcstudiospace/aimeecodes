...
```bash
.omega/skills/resolve-conflicts/scripts/handle-deleted-modified.sh
```
...
```bash
.omega/skills/resolve-conflicts/scripts/validate-conflicts.sh
```
...
Co-Authored-By: OmegaLoops <noreply@omegaloops.dev>"
```
