...
```bash
bash .aimee/skills/write-release-notes/scripts/fetch-release-data.sh <version> [owner/repo]
```
...
- **Lead with what changed**: "You can now..." or "Aimee now..." beats "We added..."
...
```bash
echo "<release notes>" | bash .aimee/skills/write-release-notes/scripts/validate-release-notes.sh
```
