...
use bstr::ByteSlice;
use omega_app::CommandInfra;
use omega_domain::{CommandOutput, ConsoleWriter as OutputPrinterTrait, Environment};
...
#[derive(Clone, Debug)]
pub struct OmegaCommandExecutorService {
    env: Environment,
...
impl OmegaCommandExecutorService {
...
impl CommandInfra for OmegaCommandExecutorService {
...
mod tests {
    ...
    async fn test_command_executor() {
        let fixture = OmegaCommandExecutorService::new(test_env(), test_printer());
