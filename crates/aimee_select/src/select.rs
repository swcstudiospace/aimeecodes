...
mod tests {
    ...
    use super::*;
    use crate::AimeeWidget;

    #[test]
    fn test_select_builder_creates() {
        let builder = AimeeWidget::select("Test", vec!["a", "b", "c"]);
    ...
    fn test_confirm_builder_creates() {
        let builder = AimeeWidget::confirm("Confirm?");
    ...
    fn test_select_builder_with_initial_text() {
        let builder =
            AimeeWidget::select("Test", vec!["apple", "banana", "cherry"]).with_initial_text("app");
    ...
    fn test_select_owned_builder_with_initial_text() {
        let builder =
            AimeeWidget::select("Test", vec!["apple", "banana", "cherry"]).with_initial_text("ban");
    ...
    fn test_with_starting_cursor() {
        let builder = AimeeWidget::select("Test", vec!["a", "b", "c"]).with_starting_cursor(2);
