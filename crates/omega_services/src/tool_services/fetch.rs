...
use omega_app::{HttpResponse, NetFetchService, ResponseContext, is_binary_content_type};
...
#[derive(Debug)]
pub struct OmegaFetch {
    client: Client,
}

impl Default for OmegaFetch {
    fn default() -> Self {
        Self::new()
    }
}
...
impl NetFetchService for OmegaFetch {
