...
use anyhow::Context;
use omega_app::domain::Image;
use omega_app::{EnvironmentInfra, FileInfoInfra, ImageReadService};
use strum_macros::{Display, EnumString};

use crate::utils::assert_absolute_path;

pub struct OmegaImageRead<F> {
    infra: Arc<F>,
}
...
impl<
    F: FileInfoInfra
        ...
        + omega_app::FileReaderInfra,
> ImageReadService for OmegaImageRead<F>
{
