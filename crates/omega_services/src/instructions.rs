...
use omega_app::{CommandInfra, CustomInstructionsService, EnvironmentInfra, FileReaderInfra};
...
#[derive(Clone)]
pub struct OmegaCustomInstructionsService<F> {
    infra: Arc<F>,
    cache: tokio::sync::OnceCell<Vec<String>>,
}

impl<F: EnvironmentInfra + FileReaderInfra + CommandInfra> OmegaCustomInstructionsService<F> {
...
impl<F: EnvironmentInfra + FileReaderInfra + CommandInfra> CustomInstructionsService
    for OmegaCustomInstructionsService<F>
{
