...
use anyhow::Context;
use bytes::Bytes;
use omega_app::domain::{McpConfig, McpTrustResponse, McpTrustStore, Scope};
use omega_app::{
...
pub struct OmegaMcpManager<I> {
    infra: Arc<I>,
}

impl<I> OmegaMcpManager<I>
where
    I: McpServerInfra + FileReaderInfra + FileInfoInfra + EnvironmentInfra + KVStore,
{
    /// Creates a new [`OmegaMcpManager`] wrapping the provided infrastructure.
...
impl<I> McpConfigManager for OmegaMcpManager<I>
where
    I: McpServerInfra
        + FileReaderInfra
        + FileInfoInfra
