...
#[derive(Clone)]
pub struct OmegaMcpService<M, I, C> {
...
impl<M, I, C> OmegaMcpService<M, I, C>
where
    M: McpConfigManager,
...
mod tests {
    ...
    use super::{OmegaMcpService, generate_mcp_tool_name};
    ...
    fn fixture() -> OmegaMcpService<MockMcpManager, MockInfra, MockMcpClient> {
        OmegaMcpService::new(Arc::new(MockMcpManager), Arc::new(MockInfra))
    }
