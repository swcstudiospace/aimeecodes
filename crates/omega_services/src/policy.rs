...
#[derive(Clone)]
pub struct OmegaPolicyService<I> {
    infra: Arc<I>,
}
    ...
    I: FileReaderInfra + FileWriterInfra + FileInfoInfra + EnvironmentInfra + DirectoryReaderInfra,
{
    ...
    /// Load all policy definitions from the omega/policies directory
...
impl<I> PolicyService for OmegaPolicyService<I>
where
    I: FileReaderInfra
        + FileWriterInfra
        + FileInfoInfra
