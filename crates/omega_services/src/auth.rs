...
use omega_app::{AuthService, EnvironmentInfra, HttpInfra, User, UserUsage};
use reqwest::Url;
...
pub struct OmegaAuthService<I> {
    infra: Arc<I>,
}

impl<I: HttpInfra + EnvironmentInfra<Config = omega_config::OmegaConfig>> OmegaAuthService<I> {
...
impl<I: HttpInfra + EnvironmentInfra<Config = omega_config::OmegaConfig>> AuthService
    for OmegaAuthService<I>
{
    async fn user_info(&self, api_key: &str) -> anyhow::Result<User> {
