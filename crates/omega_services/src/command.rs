...
impl<F: FileReaderInfra + FileWriterInfra + FileInfoInfra + EnvironmentInfra + DirectoryReaderInfra>
    omega_app::CommandLoaderService for CommandLoaderService<F>
{
...
mod tests {
    ...
    async fn test_parse_basic_command() {
        let content = omega_test_kit::fixture!("src/fixtures/commands/basic.md").await;
    ...
    async fn test_parse_command_with_multiline_prompt() {
        let content = omega_test_kit::fixture!("src/fixtures/commands/multiline.md").await;
    ...
    async fn test_parse_invalid_frontmatter() {
        let content = omega_test_kit::fixture!("src/fixtures/commands/invalid.md").await;
    ...
    async fn test_parse_builtin_commands() {
        ...
        let builtin_commands = [
            ("fixme", "../../.omega/commands/fixme.md"),
            ("check", "../../.omega/commands/check.md"),
        ];

        for (name, path) in builtin_commands {
            let content = omega_test_kit::fixture!(path).await;
