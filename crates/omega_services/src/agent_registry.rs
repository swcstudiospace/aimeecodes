...
use dashmap::DashMap;
use omega_app::domain::AgentId;
use omega_app::{AgentRepository, EnvironmentInfra};
use omega_domain::{Agent, AgentInfo};
...
/// access.
pub struct OmegaAgentRegistryService<R> {
...
impl<R> OmegaAgentRegistryService<R> {
...
impl<R: AgentRepository + EnvironmentInfra<Config = omega_config::OmegaConfig>>
    OmegaAgentRegistryService<R>
{
    ...
    ///
    /// Reads the default provider and model from the latest [`OmegaConfig`]
...
impl<R: AgentRepository + EnvironmentInfra<Config = omega_config::OmegaConfig> + Send + Sync>
    omega_app::AgentRegistry for OmegaAgentRegistryService<R>
{
