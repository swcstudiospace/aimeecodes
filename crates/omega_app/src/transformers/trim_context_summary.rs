use omega_domain::{ContextSummary, Role, SummaryMessage, SummaryTool, Transformer};
...
enum Operation<'a> {
    ...
    CodebaseSearch {
        queries: &'a [omega_domain::SearchQuery],
    },
...
#[cfg(test)]
mod tests {
    use omega_domain::{Role, SummaryBlock, SummaryToolCall, ToolCallId};
