...
pub fn copilot_auto_model() -> omega_domain::Model {
    omega_domain::Model {
...
impl From<CopilotModel> for omega_domain::Model {
    fn from(value: CopilotModel) -> Self {
        ...
        let mut input_modalities = vec![omega_domain::InputModality::Text];
        if supports_image {
            input_modalities.push(omega_domain::InputModality::Image);
        }
...
mod tests {
    ...
    fn test_conversion_to_domain_model() {
        ...
        let expected = omega_domain::Model {
