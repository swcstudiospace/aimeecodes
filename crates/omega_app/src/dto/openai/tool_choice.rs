...
impl From<omega_domain::ToolChoice> for ToolChoice {
    fn from(value: omega_domain::ToolChoice) -> Self {
        match value {
            omega_domain::ToolChoice::None => ToolChoice::None,
            omega_domain::ToolChoice::Auto => ToolChoice::Auto,
            omega_domain::ToolChoice::Required => ToolChoice::Required,
            omega_domain::ToolChoice::Call(tool_name) => ToolChoice::Function {
