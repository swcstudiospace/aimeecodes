...
use omega_domain::{ChatResponseContent, Environment, TitleFormat};
...
mod tests {
    ...
    use omega_display::DiffFormat;
    use omega_domain::{ChatResponseContent, Environment, FileInfo};
    ...
    fn test_fs_read_multiple_lines() {
        ...
        let fixture = ToolOperation::FsRead {
            input: omega_domain::FSRead {
                file_path: "/home/user/test.txt".to_string(),
                range: Some(omega_domain::FSReadRange { start_line: Some(2), end_line: Some(4) }),
                show_line_numbers: true,
            },
            output: ReadOutput {
                content: Content::file(content),
    ...
    fn test_fs_create_with_warning() {
        ...
        let fixture = ToolOperation::FsWrite {
            ...
            output: FsWriteOutput {
                ...
                before: None,
                errors: vec![omega_domain::SyntaxError {
                    line: 5,
                    column: 10,
    ...
    fn test_fs_remove() {
        let fixture = ToolOperation::FsRemove {
            input: omega_domain::FSRemove { path: "/home/user/project/file.txt".to_string() },
    ...
    fn test_fs_undo() {
        let fixture = ToolOperation::FsUndo {
            input: omega_domain::FSUndo { path: "/home/user/project/test.txt".to_string() },
            output: FsUndoOutput {
    ...
    fn test_plan_create() {
        ...
        if let Some(ChatResponseContent::ToolInput(title)) = actual {
            ...
            assert_eq!(title.category, omega_domain::Category::Debug);
