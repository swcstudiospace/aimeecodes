...
/// This uses the EnvironmentService trait from omega_domain
...
pub trait AuthStrategy: Send + Sync {
    ...
    async fn init(&self) -> anyhow::Result<omega_domain::AuthContextRequest>;

    /// Complete authentication flow
    async fn complete(
        &self,
        context_response: omega_domain::AuthContextResponse,
...
pub trait StrategyFactory: Send + Sync {
    ...
    fn create_auth_strategy(
        &self,
        provider_id: omega_domain::ProviderId,
...
///
/// This trait provides access to fully-resolved domain [`omega_domain::Agent`]
/// values from:
