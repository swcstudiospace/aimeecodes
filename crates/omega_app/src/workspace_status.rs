...
use omega_domain::{FileHash, FileStatus, SyncProgress, SyncStatus};
    ...
    fn test_file_statuses() {
        ...
        let expected = vec![
            omega_domain::FileStatus::new(
                ...
                omega_domain::SyncStatus::InSync,
            ),
            omega_domain::FileStatus::new(
                "/workspace/b.rs".to_string(),
                omega_domain::SyncStatus::Modified,
            ),
            omega_domain::FileStatus::new(
                "/workspace/c.rs".to_string(),
                omega_domain::SyncStatus::Deleted,
            ),
            omega_domain::FileStatus::new(
                "/workspace/d.rs".to_string(),
                omega_domain::SyncStatus::New,
            ),
        ];
