...
impl<S: EnvironmentInfra<Config = omega_config::OmegaConfig>> TerminalContextService<S> {
...
mod tests {
    ...
    use omega_domain::{Environment, TerminalCommand, TerminalContext};
