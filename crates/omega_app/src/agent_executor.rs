...
impl<S: Services + EnvironmentInfra<Config = omega_config::OmegaConfig>> AgentExecutor<S> {
    ...
    pub async fn execute(
        ...
        let conversation = if let Some(conversation_id) = conversation_id {
            ...
            let context = omega_domain::Context::default().initiator("agent".to_string());
        ...
        // Execute the request through the OmegaApp
        let app = crate::OmegaApp::new(self.services.clone());
