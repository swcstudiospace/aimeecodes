...
use omega_domain::{SyntaxError, ValidationRepository};
...
pub struct OmegaValidationRepository<I> {
    infra: Arc<I>,
}

impl<I> OmegaValidationRepository<I> {
...
#[async_trait]
impl<I: GrpcInfra> ValidationRepository for OmegaValidationRepository<I> {
