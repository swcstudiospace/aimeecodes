...
use aimee_domain::{SyntaxError, ValidationRepository};
...
pub struct AimeeValidationRepository<I> {
    infra: Arc<I>,
}

impl<I> AimeeValidationRepository<I> {
...
#[async_trait]
impl<I: GrpcInfra> ValidationRepository for AimeeValidationRepository<I> {
