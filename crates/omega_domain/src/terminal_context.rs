...
/// zsh plugin before invoking omega:
/// - `_OMEGA_TERM_COMMANDS`   — `\x1F`-separated command strings
/// - `_OMEGA_TERM_EXIT_CODES` — `\x1F`-separated exit codes
/// - `_OMEGA_TERM_TIMESTAMPS` — `\x1F`-separated Unix timestamps
