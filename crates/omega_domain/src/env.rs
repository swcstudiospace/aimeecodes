...
/// running.
///
/// Contains only the five fields that cannot be sourced from [`OmegaConfig`]:
...
impl Environment {
    ...
    ///   `OmegaConfig::custom_history_path`. When present it overrides the
    ///   default location inside `base_path`.
    pub fn history_path(&self, custom_path: Option<&PathBuf>) -> PathBuf {
        custom_path
            .cloned()
            .unwrap_or(self.base_path.join(".omega_history"))
    }
    ...
    /// Returns the global skills directory path (~/omega/skills)
    ...
    /// Returns the project-local skills directory path (.omega/skills)
    pub fn local_skills_path(&self) -> PathBuf {
        self.cwd.join(".omega/skills")
    }
    ...
    /// Returns the project-local commands directory path (.omega/commands)
    pub fn command_path_local(&self) -> PathBuf {
        self.cwd.join(".omega/commands")
    }
...
mod tests {
    ...
    fn test_agent_cwd_path() {
        ...
        let expected = PathBuf::from("/current/working/dir/.omega/agents");
    ...
    fn test_agent_cwd_path_independent_from_agent_path() {
        ...
        let expected_agent_cwd_path = PathBuf::from("/different/current/dir/.omega/agents");
    ...
    fn test_global_skills_path() {
        let fixture: Environment = Faker.fake();
        let fixture = fixture.base_path(PathBuf::from("/home/user/.omega"));

        let actual = fixture.global_skills_path();
        let expected = PathBuf::from("/home/user/.omega/skills");
    ...
    fn test_local_skills_path() {
        ...
        let expected = PathBuf::from("/projects/my-app/.omega/skills");
    ...
    fn test_skills_paths_independent() {
        ...
        let fixture = fixture
            ...
            .base_path(PathBuf::from("/home/user/.omega"));

        let global_path = fixture.global_skills_path();
        let local_path = fixture.local_skills_path();

        let expected_global = PathBuf::from("/home/user/.omega/skills");
        let expected_local = PathBuf::from("/projects/my-app/.omega/skills");
    ...
    fn test_command_path() {
        ...
        let expected = PathBuf::from("/home/user/.omega/commands");
    ...
    fn test_command_path_local() {
        ...
        let expected = PathBuf::from("/projects/my-app/.omega/commands");
    ...
    fn test_command_paths_independent() {
        ...
        let expected_global = PathBuf::from("/home/user/.omega/commands");
        let expected_local = PathBuf::from("/projects/my-app/.omega/commands");
    ...
    fn test_global_agents_md_path() {
        ...
        let expected = PathBuf::from("/home/user/.omega/AGENTS.md");
    ...
    fn test_provider_config_path() {
        ...
        let expected = PathBuf::from("/home/user/.omega/provider.json");
