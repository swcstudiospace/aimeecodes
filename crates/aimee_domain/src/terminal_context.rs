...
/// zsh plugin before invoking aimee:
/// - `_AIMEE_TERM_COMMANDS`   — `\x1F`-separated command strings
/// - `_AIMEE_TERM_EXIT_CODES` — `\x1F`-separated exit codes
/// - `_AIMEE_TERM_TIMESTAMPS` — `\x1F`-separated Unix timestamps
