...
/// running.
///
/// Contains only the five fields that cannot be sourced from [`AimeeConfig`]:
...
impl Environment {
    ...
    ///   `AimeeConfig::custom_history_path`. When present it overrides the
    ///   default location inside `base_path`.
    pub fn history_path(&self, custom_path: Option<&PathBuf>) -> PathBuf {
        custom_path
            .cloned()
            .unwrap_or(self.base_path.join(".aimee_history"))
    }
    ...
    /// Returns the global skills directory path (~/aimee/skills)
    ...
    /// Returns the project-local skills directory path (.aimee/skills)
    pub fn local_skills_path(&self) -> PathBuf {
        self.cwd.join(".aimee/skills")
    }

    /// Returns the Hermes Agent skills tree (`~/.hermes/skills`).
    ///
    /// Category/name nesting is walked by the skill repository (depth 3).
    pub fn hermes_skills_path(&self) -> Option<PathBuf> {
        self.home.as_ref().map(|home| home.join(".hermes/skills"))
    }
    ...
    /// Returns the project-local commands directory path (.aimee/commands)
    pub fn command_path_local(&self) -> PathBuf {
        self.cwd.join(".aimee/commands")
    }
    ...
    /// Returns the standing `/goal` persistence path (base_path/goal.json).
    pub fn goal_path(&self) -> PathBuf {
        crate::GoalStore::default_path(&self.base_path)
    }
...
mod tests {
    ...
    fn test_agent_cwd_path() {
        ...
        let expected = PathBuf::from("/current/working/dir/.aimee/agents");
    ...
    fn test_agent_cwd_path_independent_from_agent_path() {
        ...
        let expected_agent_cwd_path = PathBuf::from("/different/current/dir/.aimee/agents");
    ...
    fn test_global_skills_path() {
        let fixture: Environment = Faker.fake();
        let fixture = fixture.base_path(PathBuf::from("/home/user/.aimee"));

        let actual = fixture.global_skills_path();
        let expected = PathBuf::from("/home/user/.aimee/skills");
    ...
    fn test_local_skills_path() {
        ...
        let expected = PathBuf::from("/projects/my-app/.aimee/skills");
    ...
    fn test_skills_paths_independent() {
        ...
        let fixture = fixture
            ...
            .base_path(PathBuf::from("/home/user/.aimee"));

        let global_path = fixture.global_skills_path();
        let local_path = fixture.local_skills_path();

        let expected_global = PathBuf::from("/home/user/.aimee/skills");
        let expected_local = PathBuf::from("/projects/my-app/.aimee/skills");
    ...
    fn test_command_path() {
        ...
        let expected = PathBuf::from("/home/user/.aimee/commands");
    ...
    fn test_command_path_local() {
        ...
        let expected = PathBuf::from("/projects/my-app/.aimee/commands");
    ...
    fn test_command_paths_independent() {
        ...
        let expected_global = PathBuf::from("/home/user/.aimee/commands");
        let expected_local = PathBuf::from("/projects/my-app/.aimee/commands");
    ...
    fn test_global_agents_md_path() {
        ...
        let expected = PathBuf::from("/home/user/.aimee/AGENTS.md");
    ...
    fn test_provider_config_path() {
        ...
        let expected = PathBuf::from("/home/user/.aimee/provider.json");
