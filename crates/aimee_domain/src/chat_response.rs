...
pub enum Category {
    ...
    Completion,
    Warning,
    /// Built-in / MCP tool invocation (Warp-style TOOL lane).
    Tool,
    /// Skill load / skill-backed action (Warp-style SKILL lane).
    Skill,
    /// Agent handoff or agent switch (Warp-style AGENT lane).
    Agent,
}
...
impl TitleFormat {
    ...
    /// Agent handoff / agent switch lane.
