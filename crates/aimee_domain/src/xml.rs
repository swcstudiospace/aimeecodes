...
mod tests {
    ...
    fn test_extract_tag_names_with_prefix() {
        let fixture = "<aimee_tool>Something</aimee_tool> <aimee_tool_call>Content</aimee_tool_call> <other>More</other>";
        let actual = remove_tag_with_prefix(fixture, "aimee");
        // Check that both tool tags have been removed, leaving only <other> tag
        assert!(actual.contains("<other>More</other>"));
        assert!(!actual.contains("<aimee_tool>"));
        assert!(!actual.contains("<aimee_tool_call>"));
    }
    ...
    fn test_extract_tag_names_with_prefix_nested() {
        let fixture = "<parent><aimee_tool>Inner</aimee_tool><aimee_tool_call>Nested</aimee_tool_call></parent>";
        let actual = remove_tag_with_prefix(fixture, "aimee");
    ...
    fn test_extract_tag_names_with_prefix_duplicates() {
        let fixture =
            "<aimee_tool>First</aimee_tool><other>Middle</other><aimee_tool>Second</aimee_tool>";
        let actual = remove_tag_with_prefix(fixture, "aimee");
    ...
    fn test_extract_tag_names_with_prefix_attributes() {
        let fixture = "<aimee_tool id=\"1\">Content</aimee_tool> <aimee_tool_call class=\"important\">More</aimee_tool_call>";
        let actual = remove_tag_with_prefix(fixture, "aimee");
    ...
    fn test_remove_tag_with_prefix() {
        let fixture = "<aimee_task>Task details</aimee_task> Regular text <aimee_analysis>Analysis details</aimee_analysis>";
        let actual = remove_tag_with_prefix(fixture, "aimee_");
