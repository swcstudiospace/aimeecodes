...
/// Frequency at which aimee checks for updates
...
pub struct Update {
    /// How frequently aimee checks for updates: daily, weekly, always, or never
...
mod tests {
    ...
    fn test_f64_eviction_window_deserialize_round_trip() {
        ...
        let config_fixture = AimeeConfig::default().compact(fixture.clone());
    ...
    fn test_update_frequency_never_round_trip() {
        let fixture =
            AimeeConfig::default().updates(Update::default().frequency(UpdateFrequency::Never));
