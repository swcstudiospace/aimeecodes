...
use aimee_app::domain::AgentId;
use aimee_app::{AgentRepository, EnvironmentInfra};
use aimee_domain::{Agent, AgentInfo};
use dashmap::DashMap;
...
/// access.
pub struct AimeeAgentRegistryService<R> {
...
impl<R> AimeeAgentRegistryService<R> {
...
impl<R: AgentRepository + EnvironmentInfra<Config = aimee_config::AimeeConfig>>
    AimeeAgentRegistryService<R>
{
    ...
    ///
    /// Reads the default provider and model from the latest [`AimeeConfig`]
...
impl<R: AgentRepository + EnvironmentInfra<Config = aimee_config::AimeeConfig> + Send + Sync>
    aimee_app::AgentRegistry for AimeeAgentRegistryService<R>
{
