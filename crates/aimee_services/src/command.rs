    ...
    fn init_default(&self) -> anyhow::Result<Vec<Command>> {
        parse_command_iter(
            [
                ...
                ("harden", include_str!("../../../commands/harden.md")),
                ("incident", include_str!("../../../commands/incident.md")),
                ("ship", include_str!("../../../commands/ship.md")),
                ("oncall", include_str!("../../../commands/oncall.md")),
                ("rfc", include_str!("../../../commands/rfc.md")),
                ("adr", include_str!("../../../commands/adr.md")),
                ("migrate", include_str!("../../../commands/migrate.md")),
                ("perf", include_str!("../../../commands/perf.md")),
                ("slo", include_str!("../../../commands/slo.md")),
                (
                    "threat-model",
                    include_str!("../../../commands/threat-model.md"),
                ),
                (
                    "compliance",
                    include_str!("../../../commands/compliance.md"),
                ),
                ("runbook", include_str!("../../../commands/runbook.md")),
                (
                    "postmortem",
                    include_str!("../../../commands/postmortem.md"),
                ),
                (
                    "api-contract",
                    include_str!("../../../commands/api-contract.md"),
                ),
                (
                    "k8s-review",
                    include_str!("../../../commands/k8s-review.md"),
                ),
                ("cost", include_str!("../../../commands/cost.md")),
                (
                    "data-privacy",
                    include_str!("../../../commands/data-privacy.md"),
                ),
                ...
                (
                    "tpl-explain",
                    include_str!("../../../commands/tpl-explain.md"),
                ),
                ("tpl-debug", include_str!("../../../commands/tpl-debug.md")),
                (
                    "tpl-implement",
                    include_str!("../../../commands/tpl-implement.md"),
                ),
                (
                    "tpl-refactor",
                    include_str!("../../../commands/tpl-refactor.md"),
                ),
                ("tpl-tdd", include_str!("../../../commands/tpl-tdd.md")),
                ("tpl-pr", include_str!("../../../commands/tpl-pr.md")),
                (
                    "tpl-review-diff",
                    include_str!("../../../commands/tpl-review-diff.md"),
                ),
                (
                    "tpl-design",
                    include_str!("../../../commands/tpl-design.md"),
                ),
                (
                    "tpl-migrate-plan",
                    include_str!("../../../commands/tpl-migrate-plan.md"),
                ),
                (
                    "tpl-observability",
                    include_str!("../../../commands/tpl-observability.md"),
                ),
                (
                    "tpl-security-pass",
                    include_str!("../../../commands/tpl-security-pass.md"),
                ),
                (
                    "tpl-docs-inline",
                    include_str!("../../../commands/tpl-docs-inline.md"),
                ),
                (
                    "tpl-benchmark",
                    include_str!("../../../commands/tpl-benchmark.md"),
                ),
                (
                    "tpl-release-notes",
                    include_str!("../../../commands/tpl-release-notes.md"),
                ),
                (
                    "tpl-handoff",
                    include_str!("../../../commands/tpl-handoff.md"),
                ),
            ]
            .into_iter()
...
impl<F: FileReaderInfra + FileWriterInfra + FileInfoInfra + EnvironmentInfra + DirectoryReaderInfra>
    aimee_app::CommandLoaderService for CommandLoaderService<F>
{
...
mod tests {
    ...
    async fn test_parse_basic_command() {
        let content = aimee_test_kit::fixture!("src/fixtures/commands/basic.md").await;
    ...
    async fn test_parse_command_with_multiline_prompt() {
        let content = aimee_test_kit::fixture!("src/fixtures/commands/multiline.md").await;
    ...
    async fn test_parse_invalid_frontmatter() {
        let content = aimee_test_kit::fixture!("src/fixtures/commands/invalid.md").await;
    ...
    async fn test_parse_builtin_commands() {
        ...
        let builtin_commands = [
            ("fixme", "../../.aimee/commands/fixme.md"),
            ("check", "../../.aimee/commands/check.md"),
        ];

        for (name, path) in builtin_commands {
            let content = aimee_test_kit::fixture!(path).await;
    ...
    fn test_init_default_contains_builtin_commands() {
        ...
        // Built-in enterprise pack (github-pr-description + 20 packs)
        assert!(
            actual.len() >= 35,
            "expected enterprise + template pack (>=35), got {}",
            actual.len()
        );
        ...
        for name in [
            ...
            let cmd = actual
                ...
                .unwrap_or_else(|| panic!("{name} should be built-in"));
            assert!(cmd.prompt.is_some(), "{name} needs a prompt body");
            assert!(
                cmd.prompt.as_ref().unwrap().contains('<'),
                "{name} prompt should use XML tags"
            );
        }
    }
