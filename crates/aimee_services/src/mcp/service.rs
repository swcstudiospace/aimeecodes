...
#[derive(Clone)]
pub struct AimeeMcpService<M, I, C> {
...
impl<M, I, C> AimeeMcpService<M, I, C>
where
    M: McpConfigManager,
...
mod tests {
    ...
    use super::{AimeeMcpService, generate_mcp_tool_name};
    ...
    fn fixture() -> AimeeMcpService<MockMcpManager, MockInfra, MockMcpClient> {
        AimeeMcpService::new(Arc::new(MockMcpManager), Arc::new(MockInfra))
    }
