...
use aimee_app::domain::{McpConfig, McpTrustResponse, McpTrustStore, Scope};
use aimee_app::{
...
pub struct AimeeMcpManager<I> {
    infra: Arc<I>,
}

impl<I> AimeeMcpManager<I>
where
    I: McpServerInfra + FileReaderInfra + FileInfoInfra + EnvironmentInfra + KVStore,
{
    /// Creates a new [`AimeeMcpManager`] wrapping the provided infrastructure.
...
impl<I> McpConfigManager for AimeeMcpManager<I>
where
    I: McpServerInfra
        + FileReaderInfra
        + FileInfoInfra
