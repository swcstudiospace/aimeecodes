use aimee_app::{HttpResponse, NetFetchService, ResponseContext, is_binary_content_type};
...
#[derive(Debug)]
pub struct AimeeFetch {
    client: Client,
}

impl Default for AimeeFetch {
    fn default() -> Self {
        Self::new()
    }
}
...
impl NetFetchService for AimeeFetch {
