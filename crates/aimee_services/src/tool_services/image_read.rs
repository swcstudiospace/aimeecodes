...
use aimee_app::domain::Image;
use aimee_app::{EnvironmentInfra, FileInfoInfra, ImageReadService};
use anyhow::Context;
use strum_macros::{Display, EnumString};

use crate::utils::assert_absolute_path;

pub struct AimeeImageRead<F> {
    infra: Arc<F>,
}
...
impl<
    F: FileInfoInfra
        ...
        + aimee_app::FileReaderInfra,
> ImageReadService for AimeeImageRead<F>
{
