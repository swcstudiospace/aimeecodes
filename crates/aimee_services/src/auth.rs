...
use aimee_app::{AuthService, EnvironmentInfra, HttpInfra, User, UserUsage};
use reqwest::Url;
...
pub struct AimeeAuthService<I> {
    infra: Arc<I>,
}

impl<I: HttpInfra + EnvironmentInfra<Config = aimee_config::AimeeConfig>> AimeeAuthService<I> {
...
impl<I: HttpInfra + EnvironmentInfra<Config = aimee_config::AimeeConfig>> AuthService
    for AimeeAuthService<I>
{
    async fn user_info(&self, api_key: &str) -> anyhow::Result<User> {
