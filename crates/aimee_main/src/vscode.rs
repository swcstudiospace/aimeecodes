...
/// Checks if the Aimee VS Code extension is installed
///
/// Checks VS Code's extension list to see if AimeeCodes.aimee-vscode is
/// installed.
pub fn is_extension_installed() -> bool {
        ...
        && let Ok(extensions) = String::from_utf8(output.stdout)
    {
        return extensions
            .lines()
            .any(|line| line.trim() == "AimeeCodes.aimee-vscode");
    }
    false
}

/// Attempts to install the Aimee VS Code extension silently
///
