//! Aimee Codes TUI palette and style helpers.
//!
...
/// High-chroma Aimee Codes palette.
pub mod palette {
    ...
    /// Deep void background (nu-ansi counterpart of [`RATATUI_VOID`]).
    pub const VOID: Color = Color::Rgb(8, 6, 18);
