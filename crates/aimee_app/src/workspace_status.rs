...
use aimee_domain::{FileHash, FileStatus, SyncProgress, SyncStatus};
    ...
    fn test_file_statuses() {
        ...
        let expected = vec![
            aimee_domain::FileStatus::new(
                ...
                aimee_domain::SyncStatus::InSync,
            ),
            aimee_domain::FileStatus::new(
                "/workspace/b.rs".to_string(),
                aimee_domain::SyncStatus::Modified,
            ),
            aimee_domain::FileStatus::new(
                "/workspace/c.rs".to_string(),
                aimee_domain::SyncStatus::Deleted,
            ),
            aimee_domain::FileStatus::new(
                "/workspace/d.rs".to_string(),
                aimee_domain::SyncStatus::New,
            ),
        ];
