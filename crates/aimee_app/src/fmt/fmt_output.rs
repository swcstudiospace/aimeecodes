...
use aimee_domain::{ChatResponseContent, Environment, TitleFormat};
    ...
    fn to_content(&self, env: &Environment) -> Option<ChatResponseContent> {
        match self {
            ...
            ToolOperation::PlanCreate { input: _, output } => Some({
                let title = TitleFormat::tool(format!(
                    "Create {}",
...
mod tests {
    ...
    use aimee_display::DiffFormat;
    use aimee_domain::{ChatResponseContent, Environment, FileInfo};
    ...
    fn test_fs_read_multiple_lines() {
        ...
        let fixture = ToolOperation::FsRead {
            input: aimee_domain::FSRead {
                file_path: "/home/user/test.txt".to_string(),
                range: Some(aimee_domain::FSReadRange { start_line: Some(2), end_line: Some(4) }),
                show_line_numbers: true,
            },
            output: ReadOutput {
                content: Content::file(content),
    ...
    fn test_fs_create_with_warning() {
        ...
        let fixture = ToolOperation::FsWrite {
            ...
            output: FsWriteOutput {
                ...
                before: None,
                errors: vec![aimee_domain::SyntaxError {
                    line: 5,
                    column: 10,
    ...
    fn test_fs_remove() {
        let fixture = ToolOperation::FsRemove {
            input: aimee_domain::FSRemove { path: "/home/user/project/file.txt".to_string() },
    ...
    fn test_fs_undo() {
        let fixture = ToolOperation::FsUndo {
            input: aimee_domain::FSUndo { path: "/home/user/project/test.txt".to_string() },
            output: FsUndoOutput {
    ...
    fn test_plan_create() {
        ...
        if let Some(ChatResponseContent::ToolInput(title)) = actual {
            ...
            assert_eq!(title.category, aimee_domain::Category::Tool);
