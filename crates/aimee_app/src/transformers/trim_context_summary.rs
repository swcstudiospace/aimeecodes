use aimee_domain::{ContextSummary, Role, SummaryMessage, SummaryTool, Transformer};
...
enum Operation<'a> {
    ...
    CodebaseSearch {
        queries: &'a [aimee_domain::SearchQuery],
    },
...
#[cfg(test)]
mod tests {
    use aimee_domain::{Role, SummaryBlock, SummaryToolCall, ToolCallId};
