...
/// This uses the EnvironmentService trait from aimee_domain
...
pub trait AuthStrategy: Send + Sync {
    ...
    async fn init(&self) -> anyhow::Result<aimee_domain::AuthContextRequest>;

    /// Complete authentication flow
    async fn complete(
        &self,
        context_response: aimee_domain::AuthContextResponse,
...
pub trait StrategyFactory: Send + Sync {
    ...
    fn create_auth_strategy(
        &self,
        provider_id: aimee_domain::ProviderId,
...
///
/// This trait provides access to fully-resolved domain [`aimee_domain::Agent`]
/// values from:
