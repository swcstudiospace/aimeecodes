...
impl From<aimee_domain::ToolChoice> for ToolChoice {
    fn from(value: aimee_domain::ToolChoice) -> Self {
        match value {
            aimee_domain::ToolChoice::None => ToolChoice::None,
            aimee_domain::ToolChoice::Auto => ToolChoice::Auto,
            aimee_domain::ToolChoice::Required => ToolChoice::Required,
            aimee_domain::ToolChoice::Call(tool_name) => ToolChoice::Function {
