use aimee_domain::{DefaultTransformation, Provider, ProviderId, Transformer};
use url::Url;
...
impl<'a> ProviderPipeline<'a> {
    ...
    /// `AimeeConfig::merge_system_messages`).
...
mod tests {
    ...
    fn aimee(key: &str) -> Provider<Url> {
        Provider {
            ...
            url_params: vec![],
            credential: make_credential(ProviderId::AIMEE, key),
            custom_headers: None,
    ...
    fn test_supports_open_router_params() {
        assert!(supports_open_router_params(&aimee("aimee")));
    ...
    fn test_zai_provider_applies_thinking_transformation() {
        ...
        let fixture = Request::default().reasoning(aimee_domain::ReasoningConfig {
            enabled: Some(true),
            effort: None,
            max_tokens: None,
            exclude: None,
    ...
    fn test_openai_provider_trims_tool_call_ids() {
        ...
        let fixture = Request::default().messages(vec![crate::dto::openai::Message {
            ...
            content: None,
            name: None,
            tool_call_id: Some(aimee_domain::ToolCallId::new(long_id)),
            tool_calls: None,
            reasoning_details: None,
            reasoning_text: None,
            reasoning_opaque: None,
    ...
    fn test_opencode_go_deepseek_model_converts_reasoning_details_to_reasoning_content() {
        ...
        let fixture = Request::default()
            .model(aimee_domain::ModelId::new("deepseek-v4-flash"))
    ...
    fn test_opencode_go_deepseek_model_falls_back_to_empty_reasoning_content_when_none() {
        let provider = opencode_go("opencode-go");
        let fixture = Request::default()
            .model(aimee_domain::ModelId::new("deepseek-v4-pro"))
            .messages(vec![crate::dto::openai::Message {
                role: crate::dto::openai::Role::Assistant,
                content: Some(crate::dto::openai::MessageContent::Text("test".to_string())),
                name: None,
    ...
    fn test_opencode_go_deepseek_model_applies_reasoning_effort() {
        ...
        let fixture = Request::default()
            .model(aimee_domain::ModelId::new("deepseek-v4-flash"))
            .reasoning(aimee_domain::ReasoningConfig {
                enabled: Some(true),
                effort: Some(aimee_domain::Effort::High),
                max_tokens: None,
                exclude: None,
    ...
    fn test_opencode_go_non_deepseek_model_does_not_apply_deepseek_transforms() {
        let provider = opencode_go("opencode-go");
        let fixture = Request::default()
            .model(aimee_domain::ModelId::new("glm-5"))
            .messages(vec![crate::dto::openai::Message {
                role: crate::dto::openai::Role::Assistant,
                content: Some(crate::dto::openai::MessageContent::Text("test".to_string())),
                name: None,
