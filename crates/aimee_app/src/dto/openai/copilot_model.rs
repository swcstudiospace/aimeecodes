...
pub fn copilot_auto_model() -> aimee_domain::Model {
    aimee_domain::Model {
...
impl From<CopilotModel> for aimee_domain::Model {
    fn from(value: CopilotModel) -> Self {
        ...
        let mut input_modalities = vec![aimee_domain::InputModality::Text];
        if supports_image {
            input_modalities.push(aimee_domain::InputModality::Image);
        }
...
mod tests {
    ...
    fn test_conversion_to_domain_model() {
        ...
        let expected = aimee_domain::Model {
