...
impl<S: EnvironmentInfra<Config = aimee_config::AimeeConfig>> TerminalContextService<S> {
...
mod tests {
    ...
    use aimee_domain::{Environment, TerminalCommand, TerminalContext};
