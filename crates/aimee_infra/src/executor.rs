...
use aimee_app::CommandInfra;
use aimee_domain::{CommandOutput, ConsoleWriter as OutputPrinterTrait, Environment};
use bstr::ByteSlice;
...
impl AimeeCommandExecutorService {
...
impl CommandInfra for AimeeCommandExecutorService {
...
mod tests {
    ...
    async fn test_command_executor() {
        let fixture = AimeeCommandExecutorService::new(test_env(), test_printer());
