...
use omega_domain::{AgentId, Effort, ModelId, TokenCount};
...
impl ZshRPrompt {
    ...
    /// provided [`OmegaConfig`].
    pub fn from_config(config: &OmegaConfig) -> Self {
        Self::default()
...
mod tests {
    ...
    fn test_rprompt_init_state() {
        ...
        let actual = ZshRPrompt::default()
            .agent(Some(AgentId::new("omega")))
            .model(Some(ModelId::new("gpt-4")))
            .to_string();

        let expected = " %B%F{240}\u{f167a} OMEGA%f%b %F{240}\u{ec19} gpt-4%f";
    ...
    fn test_rprompt_with_tokens() {
        ...
        let expected = " %B%F{15}\u{f167a} OMEGA%f%b %B%F{15}1.5k%f%b %F{134}\u{ec19} gpt-4%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_with_tokens_and_cost() {
        ...
        let expected = " %B%F{15}\u{f167a} OMEGA%f%b %B%F{15}1.5k%f%b %B%F{2}\u{f155}0.01%f%b %F{134}\u{ec19} gpt-4%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_without_nerdfonts() {
        ...
        let expected = " %B%F{15}OMEGA%f%b %B%F{15}1.5k%f%b %F{134}gpt-4%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_with_currency_conversion() {
        ...
        let expected = " %B%F{15}\u{f167a} OMEGA%f%b %B%F{15}1.5k%f%b %B%F{2}INR0.83%f%b %F{134}\u{ec19} gpt-4%f";
        assert_eq!(actual, expected);
    }
    #[test]
    fn test_rprompt_with_eur_currency() {
        ...
        let expected = " %B%F{15}\u{f167a} OMEGA%f%b %B%F{15}1.5k%f%b %B%F{2}€0.01%f%b %F{134}\u{ec19} gpt-4%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_with_reasoning_effort_active() {
        ...
        let expected =
            " %B%F{15}\u{f167a} OMEGA%f%b %B%F{15}1.5k%f%b %F{134}\u{ec19} gpt-4%f %F{3}HIGH%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_with_reasoning_effort_init_state() {
        ...
        let expected = " %B%F{240}\u{f167a} OMEGA%f%b %F{240}\u{ec19} gpt-4%f %F{240}MEDIUM%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_with_reasoning_effort_without_nerdfonts() {
        ...
        let expected = " %B%F{15}OMEGA%f%b %B%F{15}1.5k%f%b %F{134}gpt-4%f %F{3}LOW%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_with_reasoning_effort_xhigh() {
        ...
        let expected =
            " %B%F{15}\u{f167a} OMEGA%f%b %B%F{15}1.5k%f%b %F{134}\u{ec19} gpt-4%f %F{3}XHIGH%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_reasoning_effort_narrow_terminal_uses_short_form() {
        ...
        let expected =
            " %B%F{15}\u{f167a} OMEGA%f%b %B%F{15}1.5k%f%b %F{134}\u{ec19} gpt-4%f %F{3}MED%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_reasoning_effort_wide_terminal_uses_full_form() {
        ...
        let expected =
            " %B%F{15}\u{f167a} OMEGA%f%b %B%F{15}1.5k%f%b %F{134}\u{ec19} gpt-4%f %F{3}MEDIUM%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_reasoning_effort_short_form_minimal() {
        ...
        let expected =
            " %B%F{15}\u{f167a} OMEGA%f%b %B%F{15}1.5k%f%b %F{134}\u{ec19} gpt-4%f %F{3}MIN%f";
        assert_eq!(actual, expected);
    }
}
