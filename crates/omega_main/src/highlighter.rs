...
/// Syntax highlighter for the omega readline prompt.
///
...
mod tests {
    ...
    fn test_file_mention_highlighted() {
        ...
        assert_eq!(
            parts[1],
            (theme::mention_style(), "@[src/main.rs]")
        );
    ...
    fn test_file_mention_with_symbol() {
        ...
        assert_eq!(
            parts[1],
            (theme::mention_style(), "@[src/lib.rs#my_fn]")
        );
    }
    ...
    fn test_colon_command_with_mention_in_args() {
        ...
        assert_eq!(
            parts[2],
            (theme::mention_style(), "@[src/lib.rs]")
        );
    }
