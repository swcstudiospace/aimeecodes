...
/// Checks if the Omega VS Code extension is installed
///
/// Checks VS Code's extension list to see if OmegaLoops.omega-vscode is
/// installed.
pub fn is_extension_installed() -> bool {
        ...
        && let Ok(extensions) = String::from_utf8(output.stdout)
    {
        return extensions
            .lines()
            .any(|line| line.trim() == "OmegaLoops.omega-vscode");
    }
    false
}

/// Attempts to install the Omega VS Code extension silently
///
