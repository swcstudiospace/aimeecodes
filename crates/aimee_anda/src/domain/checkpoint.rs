...
impl PathwayCheckpoint {
    ...
    pub fn from_conversation(
        ...
        let content_hash =
            Self::compute_content_hash(&parent_hash, seq, kind, &conversation, message_count);
