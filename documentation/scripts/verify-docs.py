#!/usr/bin/env python3
"""Verify the Aimee Codes GitBook documentation space.
...
- every file in documentation/ is reachable from SUMMARY.md
- no obvious secret filenames were added

Usage: python3 scripts/verify-docs.py   (from repository root)
"""
...
def main() -> int:
    ...
    print(f"OK: docs.yaml + space structure valid; {pages} pages; no broken links; nothing unreachable.")
    return 0
